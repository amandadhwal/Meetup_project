...
<head>
	<?php
		...
		$get_user = "select * from userss where user_email='$user'";
		...
		<?php
			...
			if(isset($_POST['submit'])){
				...
				if($u_cover==''){
					...
					$update = "update userss set user_cover='$u_cover.$random_number' where user_id='$user_id'";
	...
	<?php
		if(isset($_POST['update'])){
				...
				if($u_image==''){
					...
					$update = "update userss set user_image='$u_image.$random_number' where user_id='$user_id'";
